...
# 1.02 is 120 in appcast; 1.03 must be > 120 for Sparkle to offer update
[ "$VERSION" = "1.03" ] && BUILD_NUMBER=121
# 1.04 must be > 121 for Sparkle to offer update from 1.03
[ "$VERSION" = "1.04" ] && BUILD_NUMBER=122
# 1.05 must be > 122 for Sparkle to offer update from 1.04
[ "$VERSION" = "1.05" ] && BUILD_NUMBER=123
# 1.06–1.08: stepped Sparkle build numbers (must exceed prior appcast entry)
[ "$VERSION" = "1.06" ] && BUILD_NUMBER=160
[ "$VERSION" = "1.07" ] && BUILD_NUMBER=170
[ "$VERSION" = "1.08" ] && BUILD_NUMBER=180
[ "$VERSION" = "1.09" ] && BUILD_NUMBER=190
[ "$VERSION" = "1.10" ] && BUILD_NUMBER=200
[ "$VERSION" = "1.11" ] && BUILD_NUMBER=210
[ "$VERSION" = "1.12" ] && BUILD_NUMBER=220
...
git add "$APPCAST_FILE" "MediaDash/Info.plist" "MediaDashFinderSync/Info.plist" "MediaDash.xcodeproj/project.pbxproj"
...
if [ "$VERSION" = "1.0" ] || [ "$VERSION" = "1.01" ] || [ "$VERSION" = "1.02" ] || [ "$VERSION" = "1.03" ] || [ "$VERSION" = "1.04" ] || [ "$VERSION" = "1.05" ] || [ "$VERSION" = "1.06" ] || [ "$VERSION" = "1.07" ] || [ "$VERSION" = "1.08" ] || [ "$VERSION" = "1.09" ] || [ "$VERSION" = "1.10" ] || [ "$VERSION" = "1.11" ] || [ "$VERSION" = "1.12" ] || [ "$VERSION" = "1.13" ] || [ "$VERSION" = "1.14" ]; then
