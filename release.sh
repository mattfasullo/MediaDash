...
if [ "$VERSION" = "1.0" ] || [ "$VERSION" = "1.01" ] || [ "$VERSION" = "1.02" ] || [ "$VERSION" = "1.03" ] || [ "$VERSION" = "1.04" ] || [ "$VERSION" = "1.05" ] || [ "$VERSION" = "1.06" ] || [ "$VERSION" = "1.07" ] || [ "$VERSION" = "1.08" ] || [ "$VERSION" = "1.09" ] || [ "$VERSION" = "1.10" ] || [ "$VERSION" = "1.11" ]; then
